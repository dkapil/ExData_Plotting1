...
png(file = "plot4.png")
par(mfcol = c(2,2))
with(powerconsumption,plot(Time,Global_active_power,type="l",xlab = "",ylab = "Global Active Power"))
...
with(powerconsumption,plot(Time,Voltage,type="l",xlab = "datetime",ylab = "Voltage"))
